...
頂部「檢查更新」可主動取得已發布資料及檢查 App 新版本，不清除收藏。底部「手信」頁提供大眾推薦／近期熱門、峴港／會安購買區域、港幣預算、攜帶提醒及來源。直達 `#page=souvenirs`；近期訊號超過 180 日自動撤下近期標籤。詳見 [SOUVENIR_GUIDE.md](SOUVENIR_GUIDE.md)。
