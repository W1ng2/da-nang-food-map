...
目前 111 個地點（100 間餐廳、11 個景點）。會安新增 3 間餐廳和 5 個景點，來源與誘評抽查限制見 [HOI_AN_DATA_AUDIT.md](HOI_AN_DATA_AUDIT.md)。三間新餐廳的門面照及完整官方營業時間待確認，不以其他圖片或推測補上。行程只將使用者確認的 Pizza 4P’s 訂位標記為已預訂，不會自動訂位。
