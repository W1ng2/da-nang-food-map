...
const place = (overrides: Partial<Place> = {}): Place => ({
  id: 'banh-xeo', kind: 'restaurant', name: 'Bánh Xèo Bà Dưỡng', address: 'Đà Nẵng', collection: 'michelin',
  ...
  priceHkdMin: 30, priceHkdMax: 30, signature: 'Bánh xèo', hours: '', hoursSourceUrl: '', schedule: null, enrichmentVerifiedAt: '', bookingAdvice: '', bookingUrl: '', phone: '', website: '', photo: null, markerImageUrl: '',
